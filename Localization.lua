...
if (GetLocale() == "deDE") then
  for AAPC_index,AAPC_value in pairs(AAPC_Locals["deDE"]) do
    AAPC_Locals[AAPC_index] = AAPC_value
  end
elseif (GetLocale() == "esMX") then
  for AAPC_index,AAPC_value in pairs(AAPC_Locals["esMX"]) do
    AAPC_Locals[AAPC_index] = AAPC_value
  end
elseif (GetLocale() == "esES") then
  for AAPC_index,AAPC_value in pairs(AAPC_Locals["esES"]) do
    AAPC_Locals[AAPC_index] = AAPC_value
  end
elseif (GetLocale() == "frFR") then
  for AAPC_index,AAPC_value in pairs(AAPC_Locals["frFR"]) do
    AAPC_Locals[AAPC_index] = AAPC_value
  end
elseif (GetLocale() == "itIT") then
  for AAPC_index,AAPC_value in pairs(AAPC_Locals["itIT"]) do
    AAPC_Locals[AAPC_index] = AAPC_value
  end
elseif (GetLocale() == "koKR") then
  for AAPC_index,AAPC_value in pairs(AAPC_Locals["koKR"]) do
    AAPC_Locals[AAPC_index] = AAPC_value
  end
elseif (GetLocale() == "ptBR") then
  for AAPC_index,AAPC_value in pairs(AAPC_Locals["ptBR"]) do
    AAPC_Locals[AAPC_index] = AAPC_value
  end
elseif (GetLocale() == "zhCN") then
  for AAPC_index,AAPC_value in pairs(AAPC_Locals["zhCN"]) do
    AAPC_Locals[AAPC_index] = AAPC_value
  end
elseif (GetLocale() == "ruRU") then
  for AAPC_index,AAPC_value in pairs(AAPC_Locals["ruRU"]) do
    AAPC_Locals[AAPC_index] = AAPC_value
  end
elseif (GetLocale() == "zhTW") then
  for AAPC_index,AAPC_value in pairs(AAPC_Locals["zhTW"]) do
    AAPC_Locals[AAPC_index] = AAPC_value
  end
end
